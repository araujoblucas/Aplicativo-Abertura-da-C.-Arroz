...
import Image1 from '../../../assets/galeries/27/1.jpg';
import Image2 from '../../../assets/galeries/27/2.jpg';
import Image3 from '../../../assets/galeries/27/3.jpg';
import Image4 from '../../../assets/galeries/27/4.jpg';

import Styles from './styles';
export default function Galery27() {
  const images = [
    {
        source: Image1,
        id: '1',
      ...
      <View style={{flex: 1}}>
        <TitleBox style={{marginTop: 25}}>
            ...
            <View  style={{fontSize: 18, width: '55%'}} >
                <TitleLinesText style={{fontSize: 20, width: '100%', textAlign: 'center'}}> 27º Abertura da</TitleLinesText>
